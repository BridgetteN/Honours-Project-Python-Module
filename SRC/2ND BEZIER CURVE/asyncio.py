...
def calculate_control_point(x0, y0, x1, y1, distance):
    ...
    control_point = (r / 2, distance)  # The "distance" value controls the curve
...
async def calculate_curved_bezier_with_new_point(P0, P1, P2, P3, P4, P5, number_of_steps):
    ...
    # Curve P3 -> P4 with more curvature by increasing distance
    control_x2, control_y2 = calculate_control_point(P3[0], P3[1], P4[0], P4[1], 1.5)  # Increase distance for more curve
    x2, y2 = calculate_bezier(P3, (control_x2, control_y2), P4, number_of_steps)

    # Curve P4 -> P5 with more curvature
    control_x3, control_y3 = calculate_control_point(P4[0], P4[1], P5[0], P5[1], 1.5)  # Increase distance for more curve
    x3, y3 = calculate_bezier(P4, (control_x3, control_y3), P5, number_of_steps)

    return x0, y0, x1, y1, x2, y2, x3, y3

async def draw_with_more_curvature(x0, y0, x1, y1, x2, y2, x3, y3, P0, P1, P2, P3, P4, P5, width=800, height=600, x_scale=100, y_scale=100, x_offset=100, y_offset=100, radius=10):
...
async def main():
    ...
    x0, y0, x1, y1, x2, y2, x3, y3 = await calculate_curved_bezier_with_new_point(P0, P1, P2, P3, P4, P5, number_of_steps)
    screen = await draw_with_more_curvature(x0, y0, x1, y1, x2, y2, x3, y3, P0, P1, P2, P3, P4, P5)
    screen.listen()
    screen.loop()
