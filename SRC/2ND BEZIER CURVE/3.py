...
def calculate_control_point(x0, y0, x1, y1, distance, curve_factor=1.5):
    # curve_factor increases the curvature
    r = sqrt((x1 - x0) ** 2 + (y1 - y0) ** 2)
    control_point = (r / 2, distance * curve_factor)  # Apply the curve factor
...
def calculate_two_arrow_bezier_with_new_point(P0, P1, P2, P3, P4, P5, number_of_steps, curve_factor=1.5):
    ...
    # Calculate the curve for P3 -> P4 with more curvature
    control_x2, control_y2 = calculate_control_point(P3[0], P3[1], P4[0], P4[1], 0.5, curve_factor)
    x2, y2 = calculate_bezier(P3, (control_x2, control_y2), P4, number_of_steps)

    # Calculate the curve for P4 -> P5 (new curve) with more curvature
    control_x3, control_y3 = calculate_control_point(P4[0], P4[1], P5[0], P5[1], 0.5, curve_factor)
...
if __name__ == '__main__':
    ...
    number_of_steps = 10
    curve_factor = 2  # Increase curvature

    x0, y0, x1, y1, x2, y2, x3, y3 = calculate_two_arrow_bezier_with_new_point(P0, P1, P2, P3, P4, P5, number_of_steps, curve_factor)
