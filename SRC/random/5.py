...
def draw(x0, y0, x1, y1, x2, y2, P0, P1, P2, P3, P4, P5, P6, P7, width=800, height=600, x_scale=100, y_scale=100,
         x_offset=100, y_offset=100, radius=10):
    screen = pydraw.Screen(width, height)

    # Draw original points
    points = [P0, P1, P2, P3, P4, P5, P6, P7]
    for point in points:
        pydraw.Oval(screen, (x_offset + x_scale * point[0]) - radius / 2,
                    height - (y_offset + y_scale * point[1]) - radius / 2, radius, radius)
    ...
    # Repeat for P4, P5, P6, P7
    number_of_steps = 100  # You can adjust this
    x3, y3, x4, y4, x5, y5 = calculate_two_arrow_bezier_with_new_point(P4, P5, P6, P7, P4, number_of_steps)

    # Draw the second set of curves
    for i in range(len(x3) - 1):
        ...
        pydraw.Line(screen, x_scale * x5[i] + x_offset, height - y_offset - y_scale * y5[i],
                    x_offset + x_scale * x5[i + 1], height - y_offset - y_scale * y5[i + 1])
...
if __name__ == '__main__':
    ...
    screen = draw(x0, y0, x1, y1, x2, y2, P0, P1, P2, P3, P4, P5, P6, P7)
    screen.listen()
    screen.loop()
