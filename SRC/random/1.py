...
def draw_curved_and_inverted(x0, y0, x1, y1, x2, y2, x3, y3, P0, P1, P2, P3, P4, P5, width=800, height=600, x_scale=100,
                             y_scale=100, x_offset=100, y_offset=100, radius=10):
...
def main():
    ...
    screen = draw_curved_and_inverted(x0, y0, x1, y1, x2, y2, x3, y3, P0, P1, P2, P3, P4, P5)
