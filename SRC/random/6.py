...
def calculate_two_arrow_bezier_with_new_point(P0, P1, P2, P3, P4, number_of_steps):
    ...
    # Shorten the segment from P2 to P4
    P4_shortened = (2.5, 3)  # Adjusted shortened endpoint for edge
    x2, y2 = calculate_bezier(P2, P2, P4_shortened, number_of_steps)
...
if __name__ == '__main__':
    ...
    P2 = (0, 3)
    P3 = (2, 2)
    P4 = (2.5, 3)  # Adjusted for a shorter edge
    number_of_steps = 10
