...
def draw_with_new_node(x0, y0, x1, y1, x2, y2, P0, P1, P2, P3, P4, width=800, height=600, x_scale=100, y_scale=100, x_offset=100, y_offset=100, radius=10):
    ...
    for points in [(x0, y0), (x1, y1), (x2, y2)]:
...
if __name__ == '__main__':
    ...
    screen = draw_with_new_node(x0, y0, x1, y1, x2, y2, P0, P1, P2, P3, P4)
    screen.listen()
    screen.loop()
